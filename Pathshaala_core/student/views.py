...
<h1 data-animation="fadeInLeft" data-delay="0.2s" class="" style="animation-delay: 0.2s;">Welcome <br> Student !</h1>
<p data-animation="fadeInLeft" data-delay="0.4s" class="" style="animation-delay: 0.4s;">Login coming up soon</p>
